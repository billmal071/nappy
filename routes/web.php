...
Route::get('most/commented', 'HomeController@commented')->name('commented');
Route::get('most/viewed', 'HomeController@viewed')->name('viewed');
Route::get('most/downloads', 'HomeController@downloads')->name('downloads');
Route::get('photos/premium', 'HomeController@premium')->name('premium');

Route::get('sponsored', 'HomeController@sponsored')->name('sponsored');
...
// Collections Detail
Route::get('{user}/collection/{id}/{slug?}','UserController@collectionDetail' )->name('collection-details');
...
// Photo Details
Route::get('photo/{id}/{slug?}','ImagesController@show')->name('photo-details');
...
Route::group(['middleware' => 'auth'], function() {
	...
	// Purchase Photo
	Route::get('purchase/{token_id}/{type}','ImagesController@purchase');
...
// PayPal IPN
Route::post('paypal/ipn','AddFundsController@paypalIpn');
