                                ...
                                <tr>
                                    <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                        ...
                                        <h1 style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">
                                            Your photo has now been uploaded in {{$settings->title}} and awaiting for Admin's approval. You may want to review Nappy's <a href="{{url('page/terms')}}">terms</a>. For now, why don't you look at
                                            <a href="{{url('featured')}}">
                                                featured page
                                            </a>?
                                        </h1>
                                        ...
                                        <!-- Intro -->
                                            <p>
                                                You may
                                                <a href="{{url('photo',$photo_id)}}">Click here</a> to see your photo
                                            </p>
