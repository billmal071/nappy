...
<div id="ajaxmodal">
                ...
                <div class="offset-lg-6 col-lg-4 col-sm-4 col-xs-3">
                    <div class="btn-group btn-block margin-bottom-20 download-btn-div">
                        @if (
                            ...
                            <button
                                type="button"
                                class="btn btn-success btn-sm btn-block dropdown-toggle text-label"
                                id="downloadBtn"
            ...
            <div class="container rel-img-div">
                ...
                <div class="btn-block margin-bottom-20 po">
                    <div
                        ...
                        class="rel-flex-img flex-images btn-block margin-bottom-40">
        ...
        <div class="row">
            <div class="container spon-img-div">
                <h6 class="text-center">
                    {{trans('misc.sponsored_photo')}}
                </h6>
                <div class="btn-block margin-bottom-20 po">
                    <div 
                        style="display: flex; justify-content: center;"
                        class="spon-flex-img flex-images btn-block margin-bottom-40">
        ...
        <div class="row">
            <div class="row margin-bottom-20">
                <div class="col-md-3 col-md-offset-3">
                    <a class="btn btn-success btn-block margin-bottom-5 photo-alter-btn">
                        <i class="fa fa-pencil myicon-right "></i>
                        {{trans('admin.edit')}}
                    </a>
                </div>
                <div class="col-md-3">
                    <a
                        ...
                        id="deletePhoto"
                        data-url="{{ url('delete/photo',$response->id) }}">
                            <i class="fa fa-times-circle myicon-right "></i>
                            {{trans('admin.delete')}}
                    </a>
                </div>
            </div>
    ...
    @if( Auth::check() &&
        ...
        $response->user()->paypal_account != '' || Auth::guest() &&
        $response->user()->paypal_account != '' )
