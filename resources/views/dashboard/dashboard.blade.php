      ...
      <div class="content-wrapper">
        ...
        <div class="row">
								...
								@foreach( $_purchases->take(5)->get() as $purchase )
									 ...
									 <li class="item">
										 <div class="product-img">
											 <img src="{{ url('public/uploads/thumbnail',$purchase->images()->thumbnail) }}" style="height: auto !important;" />
										 </div>
           ...
           <div class="col-md-6">
             <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">{{ trans('misc.recent_photos') }}</h3>
                  <div class="box-tools pull-right">
                  </div>
                </div><!-- /.box-header -->
                ...
                switch (  $image->status ) {
                    ...
                    <li class="item">
                      <div class="product-img">
                        <img src="{{ url('public/uploads/thumbnail',$image->thumbnail) }}" style="height: auto !important;" />
                      </div>
                      <div class="product-info">
