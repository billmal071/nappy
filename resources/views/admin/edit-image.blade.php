       ...
       <div class="row">
        	...
        	<div class="box box-danger">
                ...
                <form class="form-horizontal" method="POST" action="{{ url('panel/admin/images/update') }}" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label">{{ trans('misc.sponsored')  }}</label>
                      <div class="col-sm-10">

                        <div class="radio">
                        <label class="padding-zero">
                          <input type="radio" name="sponsored" @if( $data->sponsored == 'yes' ) checked="checked" @endif value="yes" checked>
                          {{ trans('misc.yes')  }}
                        </label>
                      </div>
                      ...
                      <div class="radio">
                        <label class="padding-zero">
                          <input type="radio" name="sponsored" @if( $data->sponsored == 'no' ) checked="checked" @endif value="no">
                         {{ trans('misc.no')  }}
                        </label>
                      </div>
        ...
        <div class="col-md-3">
        	...
        	<div class="block-block text-center">
        		...
        		<img src="{{App\Helper::getUrlFromS3('path.thumbnail', $data->thumbnail)}}" class="thumbnail img-responsive">
        	</div>
