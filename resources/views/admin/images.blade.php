        ...
        <section class="content">
            ...
            @if(Session::has('info_message'))
                <div class="alert alert-warning">
                    ...
                    <i class="fa fa-warning margin-separator"></i> 
            ...
            @if(Session::has('success_message'))
                <div class="alert alert-success">
                    ...
                    <i class="fa fa-check margin-separator"></i>
                                    ...
                                    @if( $data->total() !=  0 && $data->count() != 0 )
                                        ...
                                        @foreach( $data as $image )
                                            <tr>
                                                ...
                                                <td><img src="{{App\Helper::imgixUrl('path.thumbnail', $image->thumbnail)}}" width="50" /></td>
                                                ...
                                                <td>
                                                    ...
                                                    {!! Form::open([ 'method' => 'POST', 'url' => 'panel/admin/images/delete', 'class' => 'displayInline' ]) !!}
                                        ...
                                        @endforeach
                                    @else
                                        <h3 class="text-center no-found">
                                            {{ trans('misc.no_results_found') }}
                                        </h3>

                                        @if( isset( $query ) || isset( $sort )  )
                                            <div class="col-md-12 text-center padding-bottom-15">
                                                <a href="{{url('panel/admin/images')}}" class="btn btn-sm btn-danger">
                                                    {{ trans('auth.back') }}
                                                </a>
                                            </div>
                                        @endif
