          ...
          <div class="row">
            ...
            @if(session('success_upload'))
              <div class="alert alert-success">
                ...
                <a href="{{url('panel/admin/images')}}" style="text-decoration:none;" target="_blank" class="btn btn-sm btn-warning">{{trans('bulk_upload.go_to_photos')}} <i class="fa fa-external-link-square"></i></a>
      		    </div>
            @endif
