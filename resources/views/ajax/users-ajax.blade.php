    ...
    <div class="media">
        ...
        <div class="media-body text-overflow">
            ...
            <ul class="padding-zero list-data-user">
                <li>
                    <i class="fa fa-clock-o myicon-right" aria-hidden="true"></i>
                    {{trans('misc.member_since')}}
                    {{ App\Helper::formatDate($user->date) }}
                </li>
                @if( $user->countries_id != '' )
                    <li>
                        <i class="fa fa-map-marker myicon-right" aria-hidden="true"></i>
        ...
        <div class="media-right m-right text-center data-stats">
            <div class="btn-block color-default count-data">
                {{ App\Helper::formatNumber( $user->followers()->count() ) }}
            </div>
        ...
        <div class="media-right m-right text-center data-stats">
            <div class="btn-block color-default count-data">
                {{ App\Helper::formatNumber( $user->images()->count() ) }}
            </div>
            <div class="btn-block color-link data-refer">
